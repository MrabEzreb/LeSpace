...
public class GameLoop implements Screen {
	...
	public void show() {
		Gdx.graphics.setDisplayMode((int)GlobalScreen.GAME_WIDTH, (int)GlobalScreen.GAME_HEIGHT, true);
...
//		
		gameBatch.begin();
//		effect.draw(batch);
		gameManager.renderGame(gameBatch, dt);
		gameBatch.end();
...
//		//
	...
	public void resize(int width, int height) {
		...
		gameBatch.dispose();
		gameBatch = new SpriteBatch();
		gameManager.resizeInterfaces(Gdx.graphics.getWidth(), Gdx.graphics.getHeight());
	}
