...
public class GUIHotBar extends GraphicsUserInterface{
	...
	public GUIHotBar(int GUI_ID, int width, int height, int spacing, Sprite sprite){
		super(GUI_ID, sprite.getX(), sprite.getY(), sprite.getWidth()*width, sprite.getHeight()*height);
